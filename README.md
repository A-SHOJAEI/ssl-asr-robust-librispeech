...
The current committed artifacts come from the default smoke pipeline (`configs/smoke.yaml`), which trains for 30 steps on a tiny synthetic dataset generated by `scripts/make_smoke_data.py`. WER values are therefore not research-meaningful.
